...
const StatisticsCards = ({
    ...
    const stats = useMemo(() => {
        ...
        const topPerformers = data.filter(
            (company) => (Number(company.overallScore) || 0) >= 8,
        ).length;
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Average across all companies</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Average strategic alignment</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Average execution capability</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Companies selected</p>
                </CardContent>
            </Card>
        </div>
    );
                    ...
                    <Card className="mt-8">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div>
                                    <h4 className="font-semibold mb-2">Table Features</h4>
                                    <ul className="text-sm text-gray-600 space-y-1">
