...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "hidden h-full shrink-0 bg-neutral-100 md:flex md:flex-col dark:bg-neutral-800",
          className,
        )}
        animate={{
      ...
      >
        <motion.div
          ...
          animate={{
            padding: animate ? (open ? "1rem" : "0.5rem") : "1rem",
          }}
        >
          {children}
        </motion.div>
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="overflow-hidden text-sm whitespace-pre text-neutral-700 transition duration-150 group-hover/sidebar:translate-x-1 dark:text-neutral-200"
      >
        {link.label}
      </motion.span>
    </a>
