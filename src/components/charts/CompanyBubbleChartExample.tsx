...
export const CompanyBubbleChartExample = ({ data, loading = false }: CompanyBubbleChartExampleProps) => {
        ...
        <div className="space-y-6">
                    ...
                    <div className="mt-3 pt-3 border-t border-blue-200">
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span className="ml-2 text-blue-600">
                                    {selectedCompany.annual_revenue ? `$${selectedCompany.annual_revenue.toFixed(1)}B` : "N/A"}
                                </span>
                            </div>
                        </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                    <li>• <strong>X-axis:</strong> Strategic Fit (0-10 scale)</li>
                    <li>• <strong>Y-axis:</strong> Ability to Execute (0-10 scale)</li>
                    <li>• <strong>Bubble Size:</strong> Overall Score (0-10 scale)</li>
                    <li>• <strong>Colors:</strong> Categorized by company tier</li>
                    <li>• <strong>Interactive:</strong> Click and hover for company details</li>
                    <li>• <strong>Filtering:</strong> Filter by company tiers</li>
                    <li>• <strong>Responsive:</strong> Adapts to container size</li>
                    <li>• <strong>Data Source:</strong> Integrated with existing company table data</li>
                </ul>
            </div>
        </div>
    );
