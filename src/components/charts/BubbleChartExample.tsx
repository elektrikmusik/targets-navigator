    ...
    <div className="space-y-6">
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">Strategic Analysis Dashboard</h2>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 text-blue-600">
                    ...
                    {(selectedDataPoint.metadata as any).team} people
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="rounded-lg bg-gray-50 p-4">
        ...
        <ul className="space-y-1 text-sm text-gray-600">
          <li>
            • <strong>X-axis:</strong> Strategic Fit (0-100%)
          </li>
          <li>
            • <strong>Y-axis:</strong> Ability to Execute (0-100%)
          </li>
          <li>
            • <strong>Bubble Size:</strong> Overall Score (0-100%)
          </li>
          <li>
            • <strong>Colors:</strong> Categorized by project type
          </li>
          <li>
            • <strong>Interactive:</strong> Click and hover for details
          </li>
          <li>
            • <strong>Responsive:</strong> Adapts to container size
          </li>
          <li>
            • <strong>Accessible:</strong> Keyboard navigation and screen reader support
          </li>
        </ul>
      </div>
    </div>
